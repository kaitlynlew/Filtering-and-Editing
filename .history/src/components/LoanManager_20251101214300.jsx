...
function LoanList({ books, loans }) { // Removed 'onReturnBook' from props
                ...
                <ul className="loan-list">
                    {loanedBooksDetails.map(loan => (
                        <li key={loan.isbn13} className="loan-item">
                            ...
                            {/* Removed Return button entirely */}
                        </li>
                    ))}
                </ul>
            )}
...
function LoanManager({ books, loans, onLoanBook, onSwitchView }) { // Removed 'onReturnBook' from props
    return (
        <div className="loan-manager-content">
            ...
            <LoanList books={books} loans={loans} /> {/* Removed 'onReturnBook' prop from usage */}
        </div>
    );
}
